...
export async function Vini() {
  ...
  return (
    <section id="vini" className="bg-ink px-6 py-28 text-paper md:px-10 md:py-36">
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-white/70">{t("kicker")}</p>
          <h2 className="mt-4 font-display text-4xl leading-tight md:text-5xl">
            {t("title")}
          </h2>
          <p className="mt-5 text-sm leading-relaxed text-mist md:text-base">{t("intro")}</p>
        </div>
